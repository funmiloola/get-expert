    ...
    <section className="fixed inset-0 bg-black/75 backdrop-blur-sm z-10">
      <div className="bg-white w-70 md:w-137.5  shadow-xl absolute right-8 top-8 rounded-[18px] px-6  py-8">
        ...
        <div>
          ...
          <h2 className="text-[18px] mid:text-[20px] font-semibold text-[#030712] pt-6">
            From Idea to Launch: A Founder’s Handbook
          </h2>
          <h3 className="text-base font-semibold pt-6 text-[#030712]">
            Description
          </h3>
          ...
          <button
            ...
            className={`pt-2 text-sm font-semibold ${
              isExpanded ? "text-gray-400" : "text-[#383BCA]"
            }`}
          >
            {isExpanded ? "READ LESS" : "READ MORE"}
          </button>
        </div>
        <h4 className="text-base text-[#030712] font-semibold pt-6">
          Product information
        </h4>
        <div className="flex flex-col mid:flex-row gap-2 mid:gap-4 pt-2">
          ...
          <div>
            <div>
              <h5 className="text-lg mid:text-2xl text-[#030712] font-semibold">
                Roxanna Michealson
              </h5>
            </div>
            <div className="flex gap-9 pt-2">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-[11px] text-[#101928] font-semibold ">
                  4.9 (210 reviews)
                </p>
              </div>
              <div className="flex flex-col gap-1">
        ...
        <div className="flex flex-col mid:flex-row gap-2 mid:gap-4 pt-6">
          <p className="text-sm text-[#030712] font-semibold flex gap-2">
            Upload Date: <span className="font-medium">May 30, 2025</span>
          </p>
          <p className="text-sm text-[#030712] font-semibold flex gap-2">
            Type: <span className="font-medium">PDF</span>
          </p>
          <p className="text-sm text-[#030712] font-semibold flex gap-2">
            Price: <span className="font-medium">$45,000</span>
          </p>
        </div>
        <div className="flex flex-col mid:flex-row gap-2 mid:gap-4 pt-1">
          ...
          <p className="text-sm text-[#030712] font-semibold flex gap-2">
            Sales: <span className="font-medium">25</span>
          </p>
          <p className="text-sm text-[#030712] font-semibold flex gap-2">
            Rating: 48 <span className="font-medium">(1,059 reviews)</span>
          </p>
        </div>
        <div className="flex flex-col gap-1.5 pt-30">
          <label className="text-sm text-[#414651]">Notes</label>
          <textarea
            className="pt-3 px-3.5 pb-8 border border-[#D5D7DA] outline-none rounded-lg"
