  ...
  return (
    <>
      <div className="flex gap-2.5 justify-between pt-8">
        <h2 className="text-sm text-[#030712] font-medium">
          1-5 out of 34 Reviews
        </h2>
            ...
            <div className="border border-[#C9D0D8] rounded-xl p-6">
              ...
              <div className="flex gap-6 pt-5">
                <div className="flex items-center gap-2">
                  {rateIcons.map((rateIcon) => (
                    <img src={rateIcon} alt="review-icn" />
                  ))}
                  <span className="text-[#030712] text-sm font-bold">
                    {rating}
                  </span>
                </div>
                <div>
              ...
              <div className="flex flex-col md:flex-row gap-4 md:gap-9 pt-5">
                <h5 className="flex flex-col gap-1.5 text-[#030712] text-[10px] font-bold md:border-r md:border-r-[#F0F2F5] pr-9">
                  Session/Product Reviewed:{" "}
                  <span className="text-base">{sessionReviewed}</span>
                </h5>
                <p className="flex flex-col gap-1.5 text-[#030712] text-[10px] font-bold">
                  Duration: <span className="text-base">{duration}</span>
                </p>
              </div>
            </div>
          )
